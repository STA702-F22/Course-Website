...
- Example:  $y_i \sim N(\alpha + \beta_i, \sigma^2)$  overparameterized


--

- $\mu_i = \alpha + \beta_i$ and $\sigma^2$ are uniquely estimated, but not $\alpha$ or $\beta_i$
