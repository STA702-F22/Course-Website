...
Go to Github classroom to create a repository for this assignment  at [lab2](https://classroom.github.com/a/0tbfWiFw)
...
You MUST submit both your final .Rnw and .pdf files to the repo on Github and upload the pdf to Gradescope here: https://www.gradescope.com/courses/295827/assignments. (We are experimenting with linking Github with Gradescope so that your files are automatically linked.)
