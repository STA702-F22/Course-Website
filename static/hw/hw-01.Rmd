...
Go to Github classroom to  accept the invitation to create a repository for this assignment  at [HW1](https://classroom.github.com/a/4liRAttG)
...
Follow the instructions in the README in your repo and in the hw1.Rnw file to complete the assignment. 

## Github Classroom & Gradescope

You MUST submit both your final .Rnw and .pdf files to the repo on Github and upload the pdf to Gradescope here: https://www.gradescope.com/courses/295827/assignments. (We are experimenting with linking Github with Gradescope so that your files are automatically linked, but for now check and upload the pdf manually if need be.)
