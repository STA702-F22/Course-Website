...
Go to Github classroom to  accept the invitation to create a repository for this assignment  at [HW10](https://classroom.github.com/a/VM5X8BQJ
...
You MUST submit your final `Rnw` and  `pdf` files to the repo on Github and upload the `pdf` to Gradescope here:  https://www.gradescope.com/courses/431637/assignments  Please remember to push your updates to GitHub regularly.
